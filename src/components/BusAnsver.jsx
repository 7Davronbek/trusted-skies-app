                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="row">
                                <div className="col-6">
                                    <div className="Bus_ansver_box">
                                        <div className="Bus_ansver_box_h">
                                            How to book cheap business class flights?
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="Bus_ansver_box_2">
                                        <div className="Bus_ansver_box_p">
